...
$allowedOrigins = array_values(array_filter(array_map('trim', explode(',', (string) env('REVERB_ALLOWED_ORIGINS', 'localhost')))));
...
return [
    ...
    'apps' => [
        ...
        'apps' => [[
            ...
            'options' => [
                'host' => env('REVERB_HOST'), 'port' => env('REVERB_PORT', 443),
                'scheme' => env('REVERB_SCHEME', 'https'), 'useTLS' => env('REVERB_SCHEME', 'https') === 'https',
            ],
