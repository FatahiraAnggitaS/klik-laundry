...
it('migrates forward and rolls back on an isolated sqlite database', function () {
    ...
    try {
        ...
        expect(Schema::connection('m2_roundtrip')->hasTable('payment_channels'))->toBeTrue()
            ...
            ->and(Schema::connection('m2_roundtrip')->hasTable('notifications'))->toBeTrue()
            ->and(Schema::connection('m2_roundtrip')->hasTable('refund_requests'))->toBeTrue()
            ->and(Schema::connection('m2_roundtrip')->hasTable('financial_adjustments'))->toBeTrue()
            ->and(Schema::connection('m2_roundtrip')->hasTable('tenant_payouts'))->toBeTrue()
            ->and(Schema::connection('m2_roundtrip')->hasTable('tenant_payout_items'))->toBeTrue()
